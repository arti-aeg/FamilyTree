SELECT 
  ...
  lud.lud_rok_ur rok_ur,
  lud.lud_rok_zg rok_zg,
...
WHERE 
  ...
  lud.lud_activ=1 AND
  ((lud.lud_rok_ur>0 AND lud.lud_rok_ur<(SELECT MAX(lud_rok_ur+13) FROM lud_ludzie WHERE lud_activ>0 AND lud_rok_ur>0 AND (lud.lud_lud_ojciec=lud_id OR lud.lud_lud_matka=lud_id)) OR
  lud.lud_rok_ur>LEAST((SELECT MIN(lud_rok_zg+1-lud.lud_plec) FROM lud_ludzie WHERE lud_activ>0 AND lud_rok_zg>0 AND (lud.lud_lud_ojciec=lud_id OR lud.lud_lud_matka=lud_id)),
  (SELECT MIN(lud_rok_ur)-13 FROM lud_ludzie WHERE lud_activ>0 AND lud_rok_ur>0 AND (lud_lud_ojciec=lud.lud_id OR lud_lud_matka=lud.lud_id)))) OR
  (lud.lud_rok_zg>0 AND lud.lud_rok_zg<(SELECT MAX(lud_rok_ur)-1+lud.lud_plec FROM lud_ludzie WHERE lud_activ>0 AND lud_rok_ur>0 AND (lud_lud_ojciec=lud.lud_id OR lud_lud_matka=lud.lud_id))))